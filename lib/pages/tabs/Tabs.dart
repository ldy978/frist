    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
          ...
          backgroundColor:
              this._currentIndex == 2 ? Colors.red : Colors.yellow, //悬浮按钮背景色
        ),
      ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          new BottomNavigationBarItem(
            icon: new Icon(Icons.add, color: _bottomNavigationIconColor),
            title: new Text("发布",
                style: TextStyle(color: _bottomNavigationTextColor)),
          ),
          BottomNavigationBarItem(
          ...
          BottomNavigationBarItem(
              icon:
                  Icon(Icons.account_circle, color: _bottomNavigationIconColor),
              title: Text("我的",
                  style: TextStyle(color: _bottomNavigationTextColor))),
        ],
      ),
